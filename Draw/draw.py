...
def Draw(data,features,*xml):
    ...
    for key, values in graph_dict.items():
        ...
        if chart_type == 'scatter':
            ...
            plt.savefig(f'graph/5/scatter{scatter}.png')
            ...
            plt.savefig(f'graph/5/catplot{catplot}.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            catplot+=1
            ...
            plt.savefig(f'graph/5/pairplot{pairplot}.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            pairplot+=1
            ...
            plt.xticks(rotation=90)
            plt.savefig(f'graph/5/countplot{countplot}.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            countplot+=1
            ...
            plt.xticks(rotation=90)
            plt.savefig(f'graph/5/displot{displot}.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            displot+=1
            ...
            plt.xticks(rotation=90)
            plt.savefig(f'graph/5/regplot{regplot}.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            regplot+=1
            ...
            plt.savefig(f'graph/5/violinplot{regplot}.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            violinplot+=1
            ...
            plt.xticks(rotation=90)
            plt.savefig(f'graph/5/bubbleplot{bubbleplot}.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            bubbleplot+=1
    ...
    for combo in final_combinations:
        ...
        if(pd.api.types.is_numeric_dtype(data[scatter_col])):
            ...
            p.fig.savefig(f'graph/5/facetGrid_{facetGrid}.png') 

...
def Draw(data,features,*xml):
    ...
    for key, values in graph_dict.items():
        ...
        if chart_type == 'scatter':
            ...
            plt.savefig('graph/4/scatter.png')
            ...
            plt.savefig('graph/4/catplot.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.savefig('graph/4/pairplot.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.xticks(rotation=90)
            plt.savefig('graph/4/countplot.png')
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.xticks(rotation=90)
            plt.savefig('graph/4/displot.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.xticks(rotation=90)
            plt.savefig('graph/4/regplot.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.savefig('graph/4/violinplot.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
            ...
            plt.xticks(rotation=90)
            plt.savefig('graph/4/bubbleplot.png') 
            pdf_pages.savefig(fig)
            plt.show()
            plt.close()
        plt.close()
    ...
    for combo in combinations_list:
        ...
        if(pd.api.types.is_numeric_dtype(data[scatter_col])):
            ...
            p.fig.savefig(f'graph/4/facetGrid_{facetGrid}.png') 

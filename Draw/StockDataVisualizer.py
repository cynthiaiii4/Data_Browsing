...
class StockDataVisualizer:
    ...
    def get_heat_map_all(self):
        ...
        fig.write_html('graph/5/my_plot.html')
        fig.show()
    ...
    def get_industry_pie_all(self):
        ...
        plt.savefig('graph/5/my_pie_plot.png')
        plt.show()
        ...
        fig.show()
        fig.write_html('graph/5/my_pie_plot.html')
    ...
    def get_bar_chart_all(self):
        ...
        plt.xlabel("股價變化率")
        plt.ylabel("數量")
        plt.savefig('graph/5/my_bar_plot.png')
        plt.show()
        ...
        fig.show()
        fig.write_html('graph/5/my_bar_plot.html')
